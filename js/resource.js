...
$("#resource-sidebar-toggle-static").click(function() {
  console.log($(".resource-sidebar__bars").css("color"));
  sidebarLoaded = !sidebarLoaded;
  if ($(".resource-sidebar__bars").css("color") == "rgb(255, 255, 255)")
    $(".resource-sidebar__bars").css({ color: "#e94b3c" });
  else $(".resource-sidebar__bars").css({ color: "white" });
  if (window.innerWidth > 700) {
    if (sidebarLoaded) $("#resource-sidebar").css({ "margin-left": "0vw" });
    else $("#resource-sidebar").css({ "margin-left": "-25vw" });
  }
...
$(document).ready(function() {
  ...
  xmlHttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      // $(".resource-sidebar-folderBar").remove();
