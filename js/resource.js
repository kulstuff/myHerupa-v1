...
$(document).ready(function() {
    ...
    xmlHttp.onreadystatechange = function() {
            ...
            JSON.parse(this.responseText).files.forEach(file => {
                ...
                if (file.mimeType != "application/vnd.google-apps.folder") {
                    ...
                    branchText.className +=
                        " resource-element-branch-text display8";
                    ...
                    capsule.className +=
                        " resource-element-capsule-id-" + file.id;
                    ...
                    if (
                        !document.getElementById("resource-sidebar-folderBar")
                    ) {
                        // Create a FolderBar
                        folderBar = document.createElement("div");
                        folderBar.id = "resource-sidebar-folderBar";
                        folderBar.className +=
                            " resource-sidebar-content-folderBar";
                        ...
                        $("#resource-sidebar-folderBar").append(
                            generalChip.chip
                        );
                        ...
                        if (window.innerWidth > 700) {
                            $("#resource-sidebar-folderBar").mousewheel(
        ...
        files.map((file, index) => {
            if (index == 0) countAd = 0;
            if (index % 7 == 3 && countAd < 1 && window.innerWidth > 700)
                insertAdTile(1, "Advertisement");
...
var insertAdTile = function(spacer, branchText) {
    ...
    if (spacer == 1) {
        ...
        var elem = document.createElement("div");
        elem.className +=
            " resource-element-ad resource-element-ad-" + (countAd + 1);
        // elem.innerHTML =
