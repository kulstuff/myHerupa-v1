...
$(".societies__cards--adv-club").click(function (){
 ...
 $(".societies__cards--edc").click(function (){
   ...
   $(".div3-events-1").html('Startup-Expo');
    ...
    $(".div3-events-4").html(''); 
    $(".div3-about").css('height','50%');
    $(".div3-about").html('EDC is an initiative under Thapar University to promote and stimulate innovative ideas in technical field to incubate Entrepreneurs of tomorrow. If you have an idea, they should be the ones you shoudl approach.');
    $(".div3-contact-1").html('');
    $(".div3-contact-2").html('');
